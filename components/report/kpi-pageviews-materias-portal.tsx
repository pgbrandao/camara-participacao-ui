...
const KpiPageviewsMateriasPortal = ({ year }) => {
    ...
    <>
      <Box p={4} display={{ md: "flex" }}  w="100%">
        <Center>
          <StatGroup>
            <Stat>
              <StatNumber>{data ? formattedNumber(data['noticia_pageviews']) : <Skeleton height="20px" />}</StatNumber>
            </Stat>
          </StatGroup>
        </Center>
...
export { KpiPageviewsMateriasPortal }